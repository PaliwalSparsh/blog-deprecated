...
5. The beginning of articles is an important area to focus on. This is where author needs to hook the user into the article. Few suggestions are as follows -
            - Start with some interesting fact which compels the user to read article.
            - Share a story and start it with a BOOM!!

6. Equally critical is to understand where to end an article.
            - Stop when you start summarising or repeating content . **Readers are not dumb**.
            - Try to end with a surprise. Make the reader thirsty for more content.
            - Echo a note that is present in the starting of the article.
